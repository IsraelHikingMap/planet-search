...
final class OsmFeatureClassifier {
  ...
  enum Category {
    ...
    PLACE_CITY("icon-home", "black", "Other", 1.00, 0.0),
    PLACE_TOWN("icon-home", "black", "Other", 0.80, 0.0),
    PLACE_VILLAGE("icon-home", "black", "Other", 0.55, 0.0),
    PLACE_HAMLET("icon-home", "black", "Other", 0.35, 0.0),
    PLACE_OTHER("icon-home", "black", "Other", 0.45, 0.0),
    PLACE_BLANK("icon-home", "black", "Other", DEFAULT_BASE_SCORE, 0.0),
    ...
    INATURE("icon-inature", "#116C00", "Other", DEFAULT_BASE_SCORE, 0.0),
